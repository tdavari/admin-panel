...
$('#attach-file').on('change', function() {
    ...
    // Get the UL element where file names will be displayed
    ...
    <div class="modal-dialog m-0 me-md-4 mb-4 modal-lg">
      <div class="modal-content p-0">
        ...
        <div class="modal-body flex-grow-1 pb-sm-0 p-4 py-2">
          ...
          <form class="email-compose-form" id="emailComposeForm" action="{{ route('app-email-send') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="email-compose-to d-flex justify-content-between align-items-center">
              ...
              <div class="select2-primary border-0 shadow-none flex-grow-1 mx-2">
                <select class="select2 select-email-contacts form-select" id="emailContacts" name="emailContacts[]" multiple>
                  ...
                  <option data-avatar="{{ $user->profile_photo_url }}" value="{{ $user->email }}">{{ $user->name }}</option>
                  @endforeach
                    <!-- Loop through emails from the invitation_codes table -->
                  @foreach ($invitationCodes as $invitationCode)
                  <option data-avatar="{{ asset('assets/img/avatars/1.png') }}" value="{{ $invitationCode->email }}">{{ $invitationCode->email }}</option>
                  @endforeach
                </select>
                {{-- @dump($users) --}}
              </div>
            ...
            <div class="email-compose-cc d-none">
              ...
              <div class="d-flex align-items-center">
                ...
                <input type="text" class="form-control border-0 shadow-none flex-grow-1 mx-2" id="email-cc" name="email_cc" placeholder="someone@email.com">
              </div>
            </div>
            <div class="email-compose-bcc d-none">
              ...
              <div class="d-flex align-items-center">
                ...
                <input type="text" class="form-control border-0 shadow-none flex-grow-1 mx-2" id="email-bcc" name="email_bcc" placeholder="someone@email.com">
              </div>
            </div>
            <hr class="container-m-nx my-2">
            <div class="email-compose-subject d-flex align-items-center mb-2">
              ...
              <input type="text" class="form-control border-0 shadow-none flex-grow-1 mx-2" name="email_subject" id="email-subject" placeholder="Enter subject...">
              @error('email_subject')
            ...
            <div class="email-compose-message container-m-nx">
              ...
              <div class="email-editor" name="email_message"></div>
            </div>
            ...
            <div class="email-compose-actions d-flex justify-content-between align-items-center mt-3 mb-3">
              <div class="d-flex align-items-center">
                <div class="btn-group">
                  ...
                  <button type="submit" class="btn btn-primary" id="sendEmailBtn"  aria-label="Close"><i class="ti ti-send ti-xs me-1"></i>Send</button>
