...
document.addEventListener('DOMContentLoaded', function () {
  (function () {
    ...
    emailCompose.addEventListener('shown.bs.modal', event => {
    ...
    quill.on('text-change', function () {
      var emailMessageBody = quill.root.innerHTML;
      $('#emailComposeForm').append('<input type="hidden" name="email_message" value="' + emailMessageBody + '">');
    });
    ...
    function initSelect2() {
      if (emailContacts.length) {
        function renderContactsAvatar(option) {
          ...
          let avatarUrl = option.element.getAttribute('data-avatar'); // Get the avatar URL
          ...
          let $avatar =
            ...
            avatarUrl + // Use the avatar URL directly
